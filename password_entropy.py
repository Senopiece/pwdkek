...
def calculate_password_entropy(predefined_password):
    ...
    predefined_tokens = tokenizer(predefined_password, return_tensors="pt")["input_ids"][0][1:]
...
def main():
    ...
    entropy = calculate_password_entropy(predefined_password)
    ...
    print("Time to decode with 1Gh/s:",
